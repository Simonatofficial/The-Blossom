...
self.SW_ASSETS = [
  ...
  './js/presets/aspects.js',
  './js/presets/blueprints.js',
  './js/presets/hubs.js',
  './js/presets/liri-content.js',
  './js/presets/modules/activity.js',
  ...
  './js/presets/modules/liri.js',
  './js/presets/modules/productivity.js',
  ...
  './js/presets/tabletop/srd5e-classes.js',
  './js/presets/tabletop/srd5e-equipment.js',
  './js/presets/tabletop/srd5e-feats.js',
  './js/presets/tabletop/srd5e-index.js',
  ...
  './js/widgets/character-creator.js',
  './js/widgets/characteristic.js',
  './js/widgets/civprofile.js',
  './js/widgets/companion.js',
  './js/widgets/compendium.js',
  ...
  './js/widgets/elementquiz.js',
  './js/widgets/encounter.js',
  './js/widgets/flashcards.js',
  './js/widgets/flashcards-focus.js',
  ...
  './js/widgets/homebrew.js',
  './js/widgets/homebrew-forms.js',
  './js/widgets/homebrew-store.js',
  './js/widgets/hub.js',
  ...
  './js/widgets/lirilife.js',
  './js/widgets/liri-quiz.js',
  './js/widgets/liri-render.js',
  ...
  './js/widgets/study-streak.js',
  './js/widgets/tabletop-build.js',
  './js/widgets/tabletop-compendium.js',
  './js/widgets/time.js',
